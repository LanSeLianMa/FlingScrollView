...
import com.example.flingscrollview.common.ComputeFling;

public class LinerScrollView02 extends LinearLayout {
    ...
    public LinerScrollView02(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
